...
class PublicationForm(forms.ModelForm):
    class Meta:
        model = Publication
        fields = ["type", "title", "published_date", "accepted_date", "authors", "venue", "image", "tags", "pdf_link",
                  "code_link", "video_link"]
        help_texts = {
        ...
        widgets = {
            ...
            "accepted_date": forms.TextInput(attrs={
                "placeholder": "YYYY-MM-DD",
            }),
